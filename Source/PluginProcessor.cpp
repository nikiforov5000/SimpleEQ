...
void SimpleEQAudioProcessor::updatePeakFilter(const ChainSettings& chainSettings) {
    ...
    updateCoeffitients(leftChain.get<ChainPositions::Peak>().coefficients, peakCoefficients);
    updateCoeffitients(rightChain.get<ChainPositions::Peak>().coefficients, peakCoefficients);

}

void SimpleEQAudioProcessor::updateCoeffitients(Coefficients& old, const Coefficients& replacements) {
    *old = *replacements;
}
...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout() {
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat> ( 
        "LowCut Freq",
        "LowCut Freq",
        juce::NormalisableRange<float>(10.f, 22000.f, 1.f, 0.23f),
        1.f));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        "Peak Quality",
        "Peak Quality",
        juce::NormalisableRange<float>(0.01f, 30.f, 0.005f, 0.25f),
        1.f));
